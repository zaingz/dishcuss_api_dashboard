class RestaurantNearbySerializer < ActiveModel::Serializer
  #root :restaurant
  attributes :id , :name, :typee , :location , :latitude , :longitude , :opening ,:closing  , :distance , :rating , :price_per_head , :like , :follow  , :menu , :checkins , :reviews
  has_one :cover_image
  #has_one :menu
  #has_many :checkins 
  has_many :call_nows
